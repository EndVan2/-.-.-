...
<body>
    ...
    <center>
        <img style="width: 300px; height: 200px;" src="Img/fiz_health.png" alt="">
        <h2>Лечебная физкультура </h2>
        <p style="font-size:20px; text-align: start; width: 600px;"><b>ЛЕЧЕБНАЯ ФИЗКУЛЬТУРА (ЛФК)</b> широко используется в системе комплексного лечения и больницах, поликлиниках, санаториях. Она является ведущим методом восстановительного лечения. Правильное применение ЛФК способствует ускорению выздоровления, восстановлению нарушенной трудоспособности и возвращению больных к активной жизни.</p>
        <p style="font-size:20px; text-align: start; width: 600px;"> Основным средством ЛФК являются физические упражнения мышечные движения, являющиеся мощным биологическим стимулятором жизненных функций человека. При назначении упражнений врач учитывает особенности заболевания, характер и степень изменений в системах и органах, стадию болезненного процесса, сведения о параллельно проводимом лечении и пр. В основе лечебного действия физических упражнений лежит строго дозированная тренировка, направленная на восстановление и совершенствование нарушенных функций целостного организма и отдельных его систем и органов. </p>
        <br>
